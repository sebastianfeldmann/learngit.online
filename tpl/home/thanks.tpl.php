<div class="container py-5" id="thanks">
  <div class="row align-items-center mb-5">
    <div class="col-md-4 text-center mb-4 mb-md-0">
      <img src="/assets/gfx/layout/sf.jpg" alt="Sebastian Feldmann"
           class="rounded-circle img-fluid shadow-sm mb-3" style="max-width: 200px;">
      <h2 class="fw-bold">Sebastian Feldmann</h2>
      <p class="text-muted">Creator of LearnGit.online</p>
    </div>
    <div class="col-md-8">
      ...
      <div class="mb-4">
        <a href="https://github.com/sponsors/sebastianfeldmann" class="btn btn-primary btn-lg me-2 mb-2">
          <svg class="bi me-1" width="16" height="16"><use xlink:href="#heart"></use></svg>
          Sponsor on GitHub
        </a>
        <a href="https://github.com/sebastianfeldmann" class="btn btn-outline-secondary btn-lg mb-2">
